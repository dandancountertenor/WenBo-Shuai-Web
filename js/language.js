...
const translations = {
    'zh': {
        ...
        'about.bio1': '他拥有一个被欧洲乐评人赞誉为“富有戏剧张力”的嗓音。\n' + 
            '他成功入选由世界著名男中音托马斯·汉普森和女高音梅拉妮·迪纳在德国魏布林根创办的国际歌剧工作室，并成为该项目年度歌剧奖学金的获得者，并在魏布林根国际歌剧工作室中与专业乐团合作演出。\n ' +
            '2026年他在斯图加特的威廉玛剧院主演了由Jorg Helubeck指挥和Max Hoehn导演的蒙特威尔第的巴洛克歌剧《波佩亚的加冕》并成功饰演Ottone.他其他饰演的角色包括古诺德的《浮士德》中的西贝尔，《罗密欧与朱丽叶》中的斯蒂芬诺，以及珀塞尔的歌剧《仙女女王》中的Alto独奏家。自2019年起，他成为法国阿尔日莱斯国际艺术节的常驻演员，参与了《Faust浮士德》和《L’Elisir D’Amore爱之甘醇》等歌剧的制作。',
        'about.bio2': '近年来，他的身影活跃在全球各大顶级声乐赛场。他在意大利博洛尼亚国际声乐大赛中获得第五名及鼓励奖，在维罗纳“Vincerò”世界歌剧大赛赢得了第三名和评论家特别奖。他获得了韩国大邱国际声乐大赛的决赛奖及大都会歌剧特别奖，并入围了包括西班牙“Tenor Viñas”、瑞典“Wilhelm Stenhammar”、奥地利“Pietro Antonio Cesti”巴洛克歌剧大赛，韩国首尔国际声乐比赛等…多项国际赛事。\n' +
            '音乐会方面，他不仅在意大利博洛尼亚和维罗纳的著名音乐厅成功举办了获奖者音乐会，还在上海音乐学院和斯图加特国立音乐与表演学院的支持下，主导并参演了多场巴洛克风格与艺术歌曲专场音乐会。\n' +
            '',        
        'about.bio3': '2025年10月成为斯图加特国立音乐与表演艺术学院声乐歌剧系的硕士研究生，师从克罗地亚籍女中音歌唱家Diana Haller与教授Bernhard Epstein。在同时他有幸跟随Cherly Studer, Melanie Diener, Vivica Genaux, Renate Faltin，Melanie Diener等老师学习。他于2020至2025年间就读声乐歌剧系，师从施恒教授，也是上海音乐学院历史上首位假声男高音。',
        'about.resumeCn': '下载简历',
        'features.title': '过往活动',
    ...
    'en': {
        ...
        'about.bio1': 'He possesses a voice praised by European critics as "rich in dramatic tension."\n' + 
            'He was successfully selected for the International Opera Workshop in Waiblingen, Germany, founded by the baritone Thomas Hampson and soprano Melanie Diener, where he received the project’s annual opera scholarship. And he successfully held concerts at the Ghibellinensaal des Bürgerzentrums Waiblingen and with the Württembergischen Philharmonie Reutlingen. \n'+         
            'In 2026, he starred as Ottone in Monteverdi‘s Baroque opera L’incoronazione di Poppea at the Wilhelma Theater in Stuttgart, under the baton of conductor Jörg Halubek and directed by Max Hoehn.He has also played roles including Siebel in Gounod‘s Faust, Stéphano in Roméo et Juliette, and the Alto soloist in Purcell’s opera The Fairy Queen, among others.Since 2019, he has been a resident artist at the Festival International d‘Art Lyrique d’Argeles in France, participating in productions of operas such as Faust and L‘Elisir d’Amore.' ,
        'about.bio2': 'In recent years, he has been active in vocal competitions worldwide. He achieved fifth place and the Encouragement Award at the Bologna International Vocal Competition in Italy and won third prize along with the Critics‘Special Award at the "Vincerò" World Opera Competition in Verona. He also received the Finalist Award and the Metropolitan Opera Special Prize at the Daegu International Vocal Music Competition in South Korea and was a semi-finalist in several prestigious international competitions, including Spain‘s "Tenor Viñas," Sweden’s "Wilhelm Stenhammar," and Austria’s "Pietro Antonio Cesti" Baroque Opera Competition.\n' +
            'In addition to successfully performing in winner‘s concerts at prestigious venues in Bologna Saal Mozart and Verona Teatro Filarmonico Italy, he also organized and participated in numerous Baroque and art song recitals with the support of the Shanghai Conservatory of Music and Staatliche Hochschule für Musik und Darstellende Kunst Stuttgart.\n' +
            '',
        'about.bio3': 'In 2025, he became a Master‘s student in the Opera Department of the Staatliche Hochschule für Musik und Darstellende Kunst Stuttgart, studying under Diana Haller and Professor Bernhard Epstein. He had the privilege of learning from renowned mentors such as Cheryl Studer, Melanie Diener, Vivica Genaux, Renate Faltin...  From 2020 to 2025 he studied Vocal and Opera Studies under the tutelage of Professor Shi Heng, and was also the first countertenor in the history of the Shanghai Conservatory of Music.',
    ...
    'de': {
        ...
        'about.bio1': 'Er verfügt über eine Stimme, die von europäischen Kritikern als „reich an dramatischer Spannung“ gelobt wird.\n' + 
            'Er wurde erfolgreich in die von Bariton Thomas Hampson und Sopranistin Melanie Diener gegründete Internationale Opernwerkstatt Waiblingen aufgenommen und erhielt dort das jährliche Opernstipendium des Projekts. Zudem gab er erfolgreich Konzerte im Ghibellinensaal des Bürgerzentrums Waiblingen und mit der Württembergischen Philharmonie Reutlingen. \n'+         
            ' 2026 wird er unter der Leitung von Dirigent Jörg Halubek und Regisseur Max Hoehn im Wilhelma Theater Stuttgart die Rolle des Ottone in Monteverdis Barockoper L’incoronazione di Poppea singen.' ,
        'about.bio2': 'In den letzten Jahren war er bei internationalen Gesangswettbewerben aktiv. Beim Internationalen Gesangswettbewerb in Bologna, Italien, erreichte er den 5* Platz und erhielt den Förderpreis. Beim Weltoperettenwettbewerb "Vincerò" in Verona gewann er den 3* Preis sowie den Critics‘Special Award. Beim Daegu International Vocal Music Competition in Südkorea wurde ihm der Finalist Award und der Metropolitan Opera Special Prize verliehen. Zudem war er Halbfinalist bei mehreren renommierten internationalen Wettbewerben, darunter der "Tenor Viñas" in Spanien, der "Wilhelm Stenhammar" in Schweden und der "Pietro Antonio Cesti" Barockoper-Wettbewerb in Österreich. \n' +
            'Neben erfolgreichen Auftritten in Preisträgerkonzerten an prestigeträchtigen Veranstaltungsorten wie dem Saal Mozart in Bologna und dem Teatro Filarmonico in Verona, Italien, organisierte und wirkte er mit Unterstützung der Shanghai Conservatory of Music und der Staatlichen Hochschule für Musik und Darstellende Kunst Stuttgart an zahlreichen Barock- und Liederabenden mit.\n' +
            '',
        'about.bio3': '2025 wurde er Masterstudent im Fachbereich Oper der Staatlichen Hochschule für Musik und Darstellende Kunst Stuttgart und studierte bei Diana Haller und Professor Bernhard Epstein. Er hatte das Privileg, von renommierten Mentoren wie Cheryl Studer, Melanie Diener, Vivica Genaux und Renate Faltin zu lernen. Von 2020 bis 2025 studierte er Gesang und Oper bei Professor Shi Heng und war zugleich der erste Countertenor in der Geschichte der Shanghai Conservatory of Music.',
