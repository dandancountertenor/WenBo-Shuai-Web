...
const translations = {
  zh: {
    ...
    "about.subtitle": "关于我",
     "about.bio1":
      ...
      "他表演了以下角色：蒙特威尔第歌剧《波佩亚》中的奥托内，古诺德的《浮士德》中的西贝尔，《罗密欧与朱丽叶》中的斯蒂芬诺，以及珀塞尔的歌剧《仙女女王》中的Alto独奏家。 \n" +
    ...
    "about.bio3":
      "自2019年起，他便成为法国阿尔日莱斯国际艺术节的常驻演员，参演了《浮士德》、《爱之甘醇》等多部歌剧。在上海求学期间，他在上海饰演歌剧《浮士德》中的Siebel和《罗密欧与朱丽叶》的Stepheno。他不仅在意大利博洛尼亚和维罗纳的著名音乐厅成功举办了获奖者音乐会，还在上海音乐学院和斯图加特国立音乐与表演学院的支持下，主导并参演了多场巴洛克风格与艺术歌曲专场音乐会。",
    "about.resumeCn": "下载简历",
    "features.title": "过往活动",
    ...
    "schedule.event13":
      "Special concert by Baroque Chamber Orchestra of Shanghai Conservatory of Music",
  ...
  en: {
    ...
    "media.description":
      "Here are my latest performance videos and media content",
    ...
    "contact.description":
      "If you have any questions or cooperation intentions, please feel free to contact me",
  ...
  de: {
    ...
    "media.description":
      "Hier sind meine neuesten Auftrittsvideos und Medieninhalte",
    ...
    "schedule.description":
      "Schauen Sie sich meine bevorstehenden Aufführungen und Veranstaltungen an",
    ...
    "contact.description":
      "Wenn Sie Fragen haben oder Kooperationsabsichten, kontaktieren Sie mich bitte",
...
/** * 切换网站语言函数 * @param {string} lang - 语言代码（zh, en, de） */
