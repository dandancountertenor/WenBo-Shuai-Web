...
const translations = {
    'zh': {
        ...
        'about.bio3': '自2019年起，他便成为法国阿尔日莱斯国际艺术节的常驻演员，参演了《浮士德》、《爱之甘醇》等多部歌剧。他在上海饰演歌剧《浮士德》中的Siebel和《罗密欧与朱丽叶》的Stepheno。他不仅在意大利博洛尼亚和维罗纳的著名音乐厅成功举办了获奖者音乐会，还在上海音乐学院的支持下，主导并参演了多场巴洛克风格与艺术歌曲专场音乐会。',
        'about.resumeCn': '下载简历',
        'features.title': '过往活动',
    ...
    'en': {
        ...
        'about.bio2':'In 2025, his talent gained further recognition in the international opera community. He was successfully selected for the International Opera Workshop in Waiblingen, Germany, founded by the world-renowned baritone Thomas Hampson and soprano Melanie Diener, where he received the project‘s annual opera scholarship and performed with a professional orchestra. In 2026, he starred as Ottone in Monteverdi‘s Baroque opera L’incoronazione di Poppea at the Wilhelma Theater in Stuttgart, under the baton of conductor Jörg Halubek and directed by Max Hoehn.
            ''In recent years, he has been active in top-tier vocal competitions worldwide. He achieved 5* place and the Encouragement Award at the Bologna International Vocal Competition in Italy and won 3* prize along with the Critics Special Award at the "Vincerò" World Opera Competition in Verona. He also received the Finalist Award and the Metropolitan Opera Special Prize at the Daegu International Vocal Music Competition in South Korea and was a finalist in several prestigious international competitions, including Spain"Tenor Viñas," Sweden "Wilhelm Stenhammar," and Austria "Pietro Antonio Cesti" Baroque Opera Competition.'\n' +         
        'about.bio3': 'During his studies in Europe, he had the privilege of learning from renowned mentors such as Cheryl Studer, Melanie Diener, Vivica Genaux, Renate Faltin, and Francesca Bruni.'\n' + 
            'Since 2019, he has been a resident artist at the Festival International d’Art Lyrique d‘Aegeles in France, participating in productions of operas such as “Faust” and “L‘Elisir d’Amore”. He has performed the role of Siebel in Gounod‘s opera Faust, Stepheno in Roméo et Juliette, and as an alto soloist in Purcell’s opera The Fairy Queen. In addition to successfully performing in winner concerts at prestigious venues in Bologna and Verona, Italy, he also organized and participated in numerous Baroque and art song recitals with the support of the Shanghai Conservatory of Music and Staatliche Hochschule für Musik und Darstellende Kunst Stuttgart.
        'about.resumeCn': 'CV Download',
    ...
    'de': {
        ...
        'about.bio2': 'Im Jahr 2025 erlangte sein Talent weitere Anerkennung in der internationalen Opernszene. Er wurde erfolgreich für den International Opera Workshop in Waiblingen (Deutschland) ausgewählt, der vom weltweit bekannten Bariton Thomas Hampson und der Sopranistin Melanie Diener gegründet wurde. Dort erhielt er das jährliche Opernstipendium des Projekts und trat mit einem professionellen Orchester auf. Im Jahr 2026 übernahm er die Rolle des Ottone in Claudio Monteverdis Barockoper L’incoronazione di Poppea am Wilhelma Theater Stuttgart unter der musikalischen Leitung von Jörg Halubek und der Regie von Max Hoehn.\n',
            'In den vergangenen Jahren war er bei hochrangigen Gesangswettbewerben weltweit aktiv. Er erreichte den 5* Platz sowie den Förderpreis beim Internationalen Gesangswettbewerb von Bologna (Italien) und gewann den 3* Preis sowie den Sonderpreis der Kritiker beim internationalen Opernwettbewerb „Vincerò“ in Verona. Darüber hinaus erhielt er den Finalistenpreis und den Spezialpreis der Metropolitan Opera beim Internationalen Gesangswettbewerb in Daegu (Südkorea). Zudem war er finalist bei mehreren renommierten internationalen Wettbewerben, darunter „Tenor Viñas“ (Spanien), „Wilhelm Stenhammar“ (Schweden) und der Barockopernwettbewerb „Pietro Antonio Cesti“ (Österreich).        \n' +  
        'about.bio3': 'Während seiner Studienzeit in Europa hatte er die Möglichkeit, von renommierten Mentoren wie Cheryl Studer, Melanie Diener, Vivica Genaux, Renate Faltin und Francesca Bruni zu lernen.'
            'Seit 2019 ist er als Resident Artist beim Festival International d’Art Lyrique d’Argeles in Frankreich tätig und wirkte dort in Opernproduktionen wie Faust und L’Elisir d’Amore mit. Er sang die Rollen von Gound’Oper des Siebel in Faust sowie des Stéphano in Roméo et Juliette, Purcell’ Oper des Alto Solist in The Fariy Queen. Neben erfolgreichen Auftritten in Preisträgerkonzerten an renommierten Spielstätten in Bologna und Verona (Italien) organisierte und gestaltete er zudem zahlreiche Barock- und Kunstliedabende mit Unterstützung des Shanghaier Konservatoriums für Musik sowie der Staatlichen Hochschule für Musik und Darstellende Kunst Stuttgart.       
        'about.resumeCn': 'Lebenslauf Ansehen',
