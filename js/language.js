...
const translations = {
    ...
    'en': {
        ...
        'about.bio2': 'In 2025, his talent gained further recognition in the international opera community. He was successfully selected for the International Opera Workshop in Waiblingen, Germany, founded by the world-renowned baritone Thomas Hampson and soprano Melanie Diener, where he received the project annual opera scholarship and performed with a professional orchestra. In 2026, he starred as Ottone in Monteverdi Baroque opera L‘incoronazione di Poppea at the Wilhelma Theater in Stuttgart, under the baton of conductor Jörg Halubek and directed by Max Hoehn.'\n' +
        'about.bio3': 'In recent years, he has been active in top-tier vocal competitions worldwide. He achieved fifth place and the Encouragement Award at the Bologna International Vocal Competition in Italy and won third prize along with the Critics Special Award at the "Vincerò" World Opera Competition in Verona. He also received the Finalist Award and the Metropolitan Opera Special Prize at the Daegu International Vocal Music Competition in South Korea and was a finalist in several prestigious international competitions, including Spain"Tenor Viñas," Sweden "Wilhelm Stenhammar," and Austria "Pietro Antonio Cesti" Baroque Opera Competition.',
                      'Since 2019, he has been a resident artist at the Festival International d’Art Lyrique d‘Aix-les-Bains in France, participating in productions of operas such as Faust and L‘Elisir d’Amore. During his studies in Shanghai, he performed the roles of Siebel in Faust and Stepheno in Roméo et Juliette. In addition to successfully performing in winner concerts at prestigious venues in Bologna and Verona, Italy, he also organized and participated in numerous Baroque and art song recitals with the support of the Shanghai Conservatory of Music and Staatliche Hochschule für Musik und Darstellende Kunst Stuttgart.
